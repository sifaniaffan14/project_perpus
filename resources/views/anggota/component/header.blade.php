<div id="kt_app_header" class="app-header">
				...
				<div class="app-container container-fluid d-flex align-items-stretch h-200px"
					...
					<!--begin::Mobile logo-->
					<div class="d-flex align-items-start mt-3 flex-grow-1 flex-lg-grow-0">
						<a href="../../demo1/dist/index.html" class="d-lg-none">
							<img alt="Logo" src="assets-anggota/media/logos/default.svg" class="h-30px" />
						</a>
					</div>
					<!-- End Mobile Logo -->
					<!--begin::Header wrapper-->
					<div class="d-flex align-items-start mt-3 justify-content-end flex-lg-grow-1"
							...
							<div class="app-navbar-item ms-1 ms-lg-3">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
									...
									<div class="d-flex flex-column bgi-no-repeat rounded-top"
										style="background-image:url('assets-anggota/media/misc/menu-header-bg.jpg')">
										<!--begin::Title-->
											...
											<div class="d-flex flex-column px-9">
												...
												<div class="text-center px-4">
													<img class="mw-100 mh-200px" alt="image"
														src="assets-anggota/media/illustrations/sketchy-1/1.png" />
												</div>
												<!--end::Illustration-->
											</div>
											<!--end::Wrapper-->
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="d-flex flex-column">
												<div class="fw-bold d-flex align-items-center fs-5" id="navbar_nama_anggota"></div>
												<a href="#"
													class="fw-semibold text-muted text-hover-primary fs-7" id="navbar_username"></a>
											</div>
											<!--end::Username-->
										</div>
									</div>
...
<script>
    $.ajax({
            url: "{{ route('navbarAnggota.select') }}",
            type: 'GET',
            success: function(response) {
                if (response.status == true) {
                    var baseUrl = window.location.origin + '/storage/user/';
                    if (response.data[0]['picture'] == '' || response.data[0]['picture'] == null) {
                        response.data[0]['picture'] = 'account_box.png';
                    }
                    document.getElementById('img_navbar').setAttribute('src', baseUrl + response.data[0]['picture']);
                    document.getElementById('img_menu_item').setAttribute('src', baseUrl + response.data[0]['picture']);
                    $('#navbar_username').html(response.data[0]['username'])
                    $('#navbar_nama_anggota').html(response.data[0]['nama_anggota'])
                }
            }
        })
</script>