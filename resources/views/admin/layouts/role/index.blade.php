...
<div class="row">
    <div class="col-xl-4">
        @include('admin.layouts.role.form')
    </div>
    <div class="col-xl-8">
        <div class="data-card tax-object-card card pb-6 mb-5 mb-xl-8">
            ...
            <div class="card-body py-0">
                ...
                <table class="table table-striped" style="cursor:pointer" id="tableRole">
                    <thead>
                        <tr>
                            <th class="fw-bolder" style="width: 5%">No </th>
                            <th class="fw-bolder d-none">Id</th>
                            <th class="fw-bolder" style="width: 30%">Nama Role</th>
                        </tr>
                    </thead>
...
@section('js')
@include('admin.layouts.role.javascript')
@endsection