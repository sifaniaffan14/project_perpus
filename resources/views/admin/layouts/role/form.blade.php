<div class="accident-card card pb-6 mb-5 mb-xl-8">
    <div class="card-header border-0 align-items-center">
        <h2 class="text-dark-gray fw-bolder fs-3 mb-0"> Role User </h2>
    </div>
    <div class="card-body py-0 mt-5">
        <form action="javascript:onSave()" method="post" id="formRole" name="formRole" autocomplete="off" enctype="multipart/form-data" class="d-flex flex-column gap-5">
		    @csrf
            <input type="hidden" name="id">
            <div class="fv-row d-flex flex-column gap-1">
                <label for="nama_role" class="required fw-bolder fs-5">Nama role</label>
                <input type="text" name="nama_role" id="nama_role" placeholder="Masukkan Nama" class="border-0 py-4 px-5 fs-5" style="
