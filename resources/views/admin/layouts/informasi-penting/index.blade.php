...
<div class="row">
    <div class="col-xl-4">
        @include('admin.layouts.informasi-penting.form')
    </div>
    <div class="col-xl-8">
                ...
                <table class="table table-striped" style="cursor:pointer" id="tabelInformasi">
                    <thead>
                        <tr>
                            ...
                            <th class="fw-bolder" style="width: 68%">Isi</th>
                            <th class="fw-bolder" style="width: 22%">Tanggal</th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
...
@section('js')
@include('admin.layouts.informasi-penting.javascript')
@endsection